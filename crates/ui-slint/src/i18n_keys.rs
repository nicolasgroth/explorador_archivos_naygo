    ...
    TextUtil<'a>: Global<'a, W>,
{
    ...
    tr.set_points_recursive(c.t("points.recursive").into());
    tr.set_points_hashed(c.t("points.hashed").into());
    tr.set_points_exclusions(c.t("points.exclusions").into());
    tr.set_points_new(c.t("points.new").into());
    tr.set_points_capture(c.t("points.capture").into());
    tr.set_points_open(c.t("points.open").into());
    tr.set_points_compare(c.t("points.compare").into());
    tr.set_points_export(c.t("points.export").into());
    tr.set_points_delete(c.t("points.delete").into());
    tr.set_points_delete_confirm(c.t("points.delete_confirm").into());
    tr.set_points_basket(c.t("points.basket").into());
    tr.set_points_basket_help(c.t("points.basket_help").into());
    tr.set_points_captured(c.t("points.captured").into());
    tr.set_points_entries(c.t("points.entries").into());
    tr.set_points_complete(c.t("points.complete").into());
    tr.set_points_partial(c.t("points.partial").into());
    tr.set_points_rows_limit(c.t("points.rows_limit").into());
    tr.set_points_added(c.t("points.added").into());
    tr.set_points_modified(c.t("points.modified").into());
    tr.set_points_missing(c.t("points.missing").into());
    tr.set_points_unknown(c.t("points.unknown").into());
    tr.set_points_same_metadata(c.t("points.same_metadata").into());
    tr.set_points_same_content(c.t("points.same_content").into());
    tr.set_points_version(c.t("points.version").into());
    tr.set_points_limit(c.t("points.limit").into());
    tr.set_points_changed(c.t("points.changed").into());
    tr.set_points_invalid(c.t("points.invalid").into());
    tr.set_points_exported(c.t("points.exported").into());
    tr.set_points_recycled(c.t("points.recycled").into());
    tr.set_pane_maximize(c.t("action.maximize_pane").into());
    tr.set_edit_path(c.t("action.edit_path").into());
    ...
    tr.set_add_basket(c.t("basket.title").into());
    tr.set_add_search(c.t("pane.search.title").into());
    tr.set_add_linked_browser(c.t("slint.add.linked_browser").into());
    tr.set_tree_link_tip(c.t("tree.link.tip").into());
    tr.set_basket_title(c.t("basket.title").into());
    tr.set_basket_empty(c.t("basket.empty").into());
    tr.set_basket_copy(c.t("basket.copy").into());
    tr.set_basket_move(c.t("basket.move").into());
    tr.set_basket_delete(c.t("basket.delete").into());
    tr.set_basket_scope(c.t("basket.scope").into());
    tr.set_delivery_title(c.t("delivery.title").into());
    tr.set_spaces_title(c.t("spaces.title").into());
    tr.set_queries_title(c.t("queries.title").into());
    tr.set_queries_help(c.t("queries.help").into());
    tr.set_queries_name(c.t("queries.name").into());
    tr.set_queries_roots_help(c.t("queries.roots_help").into());
    tr.set_queries_min(c.t("queries.min").into());
    tr.set_queries_max(c.t("queries.max").into());
    tr.set_queries_date(c.t("queries.date").into());
    tr.set_queries_any(c.t("queries.any").into());
    tr.set_queries_today(c.t("queries.today").into());
    tr.set_queries_week(c.t("queries.week").into());
    tr.set_queries_days7(c.t("queries.days7").into());
    tr.set_queries_days30(c.t("queries.days30").into());
    tr.set_queries_month(c.t("queries.month").into());
    tr.set_recipes_title(c.t("recipes.title").into());
    tr.set_recipes_help(c.t("recipes.help").into());
    tr.set_recipes_name(c.t("recipes.name").into());
    tr.set_recipes_default_name(c.t("recipes.default_name").into());
    tr.set_recipes_open(c.t("recipes.open").into());
    tr.set_recipes_gather(c.t("recipes.gather").into());
    tr.set_recipes_selection(c.t("recipes.selection").into());
    tr.set_recipes_query(c.t("recipes.query").into());
    tr.set_recipes_import_query(c.t("recipes.import_query").into());
    tr.set_recipes_roots(c.t("recipes.roots").into());
    tr.set_recipes_filter(c.t("recipes.filter").into());
    tr.set_recipes_pattern(c.t("recipes.pattern").into());
    tr.set_recipes_content(c.t("recipes.content").into());
    tr.set_recipes_case(c.t("recipes.case").into());
    tr.set_recipes_wildcards(c.t("recipes.wildcards").into());
    tr.set_recipes_output(c.t("recipes.output").into());
    tr.set_recipes_destination_help(c.t("recipes.destination_help").into());
    tr.set_recipes_destination(c.t("recipes.destination").into());
    tr.set_recipes_prepare(c.t("recipes.prepare").into());
    tr.set_recipes_run(c.t("recipes.run").into());
    tr.set_recipes_loaded(c.t("recipes.loaded").into());
    tr.set_recipes_steps(c.t("recipes.steps").into());
    tr.set_recipes_examined(c.t("recipes.examined").into());
    tr.set_recipes_matched(c.t("recipes.matched").into());
    tr.set_recipes_rows_limit(c.t("recipes.rows_limit").into());
    tr.set_recipes_partial(c.t("recipes.partial").into());
    tr.set_recipes_empty(c.t("recipes.empty").into());
    tr.set_recipes_files_only(c.t("recipes.files_only").into());
    tr.set_recipes_version(c.t("recipes.version").into());
    tr.set_recipes_invalid(c.t("recipes.invalid").into());
    tr.set_queries_load(c.t("queries.load").into());
    tr.set_queries_forget(c.t("queries.forget").into());
    tr.set_queries_basket(c.t("queries.basket").into());
    tr.set_spaces_help(c.t("spaces.help").into());
    tr.set_spaces_root_help(c.t("spaces.root_help").into());
    tr.set_spaces_root(c.t("spaces.root").into());
    tr.set_spaces_working(c.t("spaces.working").into());
    tr.set_spaces_save_as(c.t("spaces.save_as").into());
    tr.set_spaces_update(c.t("spaces.update").into());
    tr.set_spaces_open(c.t("spaces.open").into());
    tr.set_spaces_save_open(c.t("spaces.save_open").into());
    tr.set_spaces_discard_open(c.t("spaces.discard_open").into());
    tr.set_delivery_group_names(c.t("delivery.group_names").into());
    tr.set_delivery_rename(c.t("delivery.rename").into());
    tr.set_delivery_open_result(c.t("delivery.open_result").into());
    tr.set_delivery_copy_result(c.t("delivery.copy_result").into());
    tr.set_delivery_back(c.t("delivery.back").into());
    tr.set_delivery_hash(c.t("delivery.hash").into());
    tr.set_delivery_help(c.t("delivery.help").into());
    tr.set_delivery_destination(c.t("delivery.destination").into());
    tr.set_delivery_grouped(c.t("delivery.grouped").into());
    tr.set_delivery_flat(c.t("delivery.flat").into());
    tr.set_delivery_relative(c.t("delivery.relative").into());
    tr.set_delivery_root(c.t("delivery.root").into());
    tr.set_delivery_prepare(c.t("delivery.prepare").into());
    tr.set_delivery_publish(c.t("delivery.publish").into());
    tr.set_delivery_waiting(c.t("delivery.waiting").into());
    tr.set_basket_select_all(c.t("basket.select_all").into());
    tr.set_basket_clear(c.t("basket.clear").into());
    tr.set_basket_remove(c.t("basket.remove").into());
    tr.set_basket_save_list(c.t("basket.save_list").into());
    tr.set_basket_open_list(c.t("basket.open_list").into());
    tr.set_destination_radar_browse(c.t("destination_radar.browse").into());
    ...
    tr.set_sync_left_to_right(c.t("sync.left_to_right").into());
    tr.set_sync_right_to_left(c.t("sync.right_to_left").into());
    tr.set_sync_bidirectional(c.t("sync.bidirectional").into());
    tr.set_sync_delete_extras(c.t("sync.delete_extras").into());
    tr.set_sync_planning(c.t("sync.planning").into());
    tr.set_sync_no_changes(c.t("sync.no_changes").into());
    tr.set_sync_apply(c.t("sync.apply").into());
    tr.set_ctx_synchronize(c.t("sync.context").into());
    tr.set_ctx_add_basket(c.t("basket.add").into());
    tr.set_ctx_transform_text(c.t("text_transform.context").into());
    tr.set_text_transform_title(c.t("text_transform.title").into());
    tr.set_text_transform_files(c.t("text_transform.files").into());
    tr.set_text_transform_detected(c.t("text_transform.detected").into());
    tr.set_text_transform_line_ending(c.t("text_transform.line_ending").into());
    tr.set_text_transform_encoding(c.t("text_transform.encoding").into());
    tr.set_text_transform_final(c.t("text_transform.final").into());
    tr.set_text_transform_preserve(c.t("text_transform.preserve").into());
    tr.set_text_transform_ensure(c.t("text_transform.ensure").into());
    tr.set_text_transform_remove(c.t("text_transform.remove").into());
    tr.set_text_transform_trim(c.t("text_transform.trim").into());
    tr.set_text_transform_apply(c.t("text_transform.apply").into());
    tr.set_text_transform_windows(c.t("text_transform.windows").into());
    tr.set_text_transform_unix(c.t("text_transform.unix").into());
    tr.set_text_transform_mac_classic(c.t("text_transform.mac_classic").into());
    ...
    tr.set_ctx_run_as_administrator(c.t("slint.ctx.run_as_administrator").into());
    ...
    tr.set_filter_toggle_hide_tip(c.t("slint.filter.toggle_hide_tip").into());
    ...
    tr.set_search_root(c.t("slint.search.root").into());
    tr.set_search_content(c.t("slint.search.content").into());
    tr.set_search_content_placeholder(c.t("slint.search.content_placeholder").into());
    tr.set_search_ignore_case(c.t("slint.search.ignore_case").into());
    tr.set_search_wildcards(c.t("slint.search.wildcards").into());
    tr.set_search_recursive(c.t("slint.search.recursive").into());
    ...
    tr.set_search_open_folder(c.t("slint.search.open_folder").into());
    ...
    tr.set_recents_most_used(c.t("slint.recents.most_used").into());
    tr.set_add_recents(c.t("slint.add.recents").into());
    ...
    tr.set_preview_loading(c.t("slint.preview.loading").into());
    ...
    tr.set_cfg_frequent_dirs_limit(c.t("slint.cfg.frequent_dirs_limit").into());
    tr.set_cfg_tip_frequent_dirs_limit(c.t("slint.cfg.tip.frequent_dirs_limit").into());
    ...
    tr.set_theme_group_surfaces(c.t("slint.theme.group.surfaces").into());
    tr.set_theme_group_rows(c.t("slint.theme.group.rows").into());
    tr.set_theme_group_text(c.t("slint.theme.group.text").into());
    tr.set_theme_group_interaction(c.t("slint.theme.group.interaction").into());
    tr.set_theme_group_alerts(c.t("slint.theme.group.alerts").into());
