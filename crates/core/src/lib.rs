...
//! No depende de la UI ni de Windows.
...
pub mod clipboard;
pub mod columns;
pub mod comparison_point;
pub mod config;
pub mod deep_listing;
pub mod delivery;
pub mod destination_radar;
pub mod disk;
pub mod dnd;
pub mod favorites;
pub mod filter;
...
pub use config::{BarPosition, OpsDisplay, OpsMode, Settings, WindowTitleMode};
